                                    ...
                                    order.orderItems.map((element) => {
                                        return (
                                            <TableRow key={element.id}>
                                                ...
                                                <TableCell className="text-right">{(element.priceInCents / 100).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</TableCell>
                                                <TableCell className="text-right">
                                                    {(element.priceInCents * element.quantity / 100).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</TableCell>
                                            </TableRow>
                                        )
                                    })
                                }
